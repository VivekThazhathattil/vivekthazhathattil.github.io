...
$(document).ready( ()=>{
	...
	$("#sub-content-0").append('<p class="big-font"> Hi! I\'m <b class="name-emphasis">Vivek!</b> I\'m an aerospace engineer with a passion for programming. I spend a lot of time solving problems that I think I could never solve and then take joy in proving me wrong. I\'m a very curious guy, and I\'m always open to learn anything new that I can apply it to my advantage. All the success I had in my life comes from strong willpower and determination, which makes me a firm believer of the proverb: <br><em>Where there\'s a will, there\'s a way!</em></p>');
